...
<head id="www-luminance-tv" data-template-set="html5-reset-wordpress-theme" profile="http://gmpg.org/xfn/11">
...
<?php	
# we're using dns verification, so no need for that block
#	<meta name="google-site-verification" content="">
#	<!-- Speaking of Google, don't forget to set your site up: http://google.com/webmasters -->

# no meta data so far. google doesn't use them at all. 
